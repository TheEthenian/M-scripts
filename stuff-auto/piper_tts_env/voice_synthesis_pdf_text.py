...
voice_location = "/home/theethenian/living_room/Projects/non-git-repos/Pluto/resources/Piper-tts/norman/en_US-norman-medium.onnx"
json_location = "/home/theethenian/living_room/Projects/non-git-repos/Pluto/resources/Piper-tts/norman/en_US-norman-medium.onnx.json"
synthesised_dictation_storage = "/home/theethenian/living_room/synthetic_voice_tts"
...
def pdf_convertion_to_text(file_path):
    ...
    end_page = input('Ending page: ')
    current_page = 0
    accumulated_converted_pdf_text = ""
    
    reader = PdfReader('/home/theethenian/'+ file_path)
...
def main():
    ...
    file_type = input("Input Propensity: Enter 1 => pdf file, Enter 2 => text file, Enter 3 => write text: ")
    audio_name = input("Name Audio File: ")
    group_placement = input("Destination Group Directory of Audio File: ")
    ...
    try:
        ...
        if int(file_type) == 1:
            ...
            file = input("File Path continue from this /home/theethenian/: ")
        ...
        if int(file_type) == 2:
            ...
            file = input("File Path continue from this /home/theethenian/: ")
            path_to_text_file = f"/home/theethenian/{file}"
        ...
        if int(file_type) == 3:
            typed_text = input("Type Text for Cori to voice synthesize: ")
